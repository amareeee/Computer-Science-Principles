...
if(roadmap=="1"){
    ...
    printf("         /      |     \\               hill               /   |    \\             \n");        
    printf("        /       |      \\            /  |   \\            /    |     \\            \n");
    printf("      help    leave    leave        /   |    \\        climb  run   fight         \n");
    printf("       |        |       |         /    |     \\         |     |      |           \n");
...
void intro(){
    printf("Hearing the sound of birds and talking, you open your eyes.\n");
    printf("Looking around you found two people talking in a panicked tone and also noticed the fact that you were on a beach.\n");
    printf("Turning to face you, the two people introduced themselves as:\n");
    scanf("%s", &nameone);
    scanf("%s", &nametwo);
    printf("%s and %s, who then explained the situation to you; you three are the only survivors of a shipwreck and must find a way to be rescued.\n", nameone, nametwo);
    printf("Deciding it would be best to stay together, you ended up finding three areas to go check out: the shipwreck, the jungle, and the hill that was a few miles away.\n");
    do{
        printf("After a few minutes you decided to 1) check out the shipwreck for any supplies, 2) go into the jungle, or 3) head over to the hill.\n");
        scanf("%d", &introans);
    }while(introans < 1 || introans > 3);
}
//option 1 of introduction
void option1(){    
    printf("In the end you chose to check out the shipwreck.\n");
    printf("Calling out for %s and %s to suggest that all of you should check the ship for any supplies left undamaged, you all head out.\n", nameone, nametwo);
    printf("As the three of you were checking the ship for any supplies, you happen to find some beef jerky, a pistol with %d bullets as well as %d matchstick(s).\n", n, m);
    printf("Out of the blue, you heard some movement coming from the edge of the jungle and decided to check it out.\n");
    printf("Quietly creeping up to the bush you swiftly pushed the leaves apart only to find out that it was a person\n");
    printf("(who you can assume was a kid cause of small they are) with a mask with some engravings on it and shaking widly.\n");
    do{
        printf("After a couple of seconds of staring at the small being you decided to 1) offer help and take them to where the others are, 2) leave them be and act like you never saw them, or 3) kill them?\n");
        scanf("%d", &op1ans);
